...
export default function FullName(props) {
    ...
    let element = (
        ...
        >
            ...
            >
                <TextField sx={{margin: "3px"}} size="small" label={data?.first_name} />
                <TextField sx={{margin: "3px"}} size="small" label={data?.middle_name} />
                <TextField sx={{margin: "3px"}} size="small" label={data?.last_name} />
            </Box>
        </Resizable>
    )
