...
export default function Button(props) {
    ...
    const [validate, setValidate] = useState(props?.data?.validate);    
    ...
    return (
        <div className='properties'>
            ...
            <div visibility={props?.visibility?.toString()} className='properties-components'>
                ...
                <span>Validate:</span>
                <select onChange={(e) => {setValidate(e.target.value); singleDataChange(e.target.value, props?.data?.id, "validate", props?.elements, props?.setElements);}}>
                    <option value="none">None</option>
